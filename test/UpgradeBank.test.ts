...
describe("Bank Contract Upgrade", function () {
  ...
  beforeEach(async function () {
    ...
    vulnerableBank = await upgrades.deployProxy(VulnerableBank, [], { initializer: 'initialize' }) as VulnerableBank;
  ...
  it("Should upgrade to SecureBank and fix vulnerability", async function () {
    ...
    secureBank = await upgrades.upgradeProxy(await vulnerableBank.getAddress(), SecureBank) as SecureBank;
